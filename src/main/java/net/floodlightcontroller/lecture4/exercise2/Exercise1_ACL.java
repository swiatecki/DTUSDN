...
import net.floodlightcontroller.custom.acl.CustomAclRule;
...
public class Exercise1_ACL implements IFloodlightModule, IOFMessageListener {
	...
	public void init(FloodlightModuleContext context) throws FloodlightModuleException {
		...
		logger = LoggerFactory.getLogger(Exercise1_ACL.class);
